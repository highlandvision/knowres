...
<form action="<?php echo $action; ?>" class="kr-search searchresults vertical" method="post" name="search-default">
	<div class="row collapse">
		<div class="small-12 columns">
			<?php if ($params->get('show_regions', 1)): ?>
				<?php echo $form->renderField('region_id', null, $initial->region_id, ['regions' => $regions]); ?>
			<?php endif; ?>
