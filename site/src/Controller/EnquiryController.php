...
class EnquiryController extends FormController
{
	...
	//	 */
	//	public function getModel($name = 'Enquiry', $prefix = 'KnowresModel',
	...
	//		$modelProperty = $this->getModel('property');
	//		$property      = $modelProperty->getItem($property_id);
	//
	...
	//		Factory::getApplication()->setUserState('com_knowres.enquiry.data', $massaged);
	//
	...
	//				$params->get('grsecretkey', ''), new CurlPost());
	...
	//		$KnowresReservationSaveEnquiryHelper = new KnowresReservationSaveEnquiryHelper(
	//			'enquiry', $massaged);
	...
	//
	//		// Post save processing for emails
	//		$KnowresReservationSaveEnquiryHelper->postSave();
	//
	//		// Clear the session data
	//		Factory::getApplication()->setUserState('com_knowres.enquiry.data', null);
	//
