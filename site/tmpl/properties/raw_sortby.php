...
if (!$this->params->get('order_ordering') && $this->params->get('order_name') && $this->params->get('order_sleeps')
...
<?php if ($this->params->get('order_ordering')): ?>
	<?php echo KrMethods::render('properties.filtersort', [
		'order'    => $this->order,
...
<?php if ($this->params->get('order_area')): ?><?php
	echo KrMethods::render('properties.filtersort', [
		'order'    => $this->order,
