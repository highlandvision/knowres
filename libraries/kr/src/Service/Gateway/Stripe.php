...
class Stripe extends Gateway
{
	...
	//TODO-v4.3 Reinstate with correct stripe processing end email notifications
	//	/**
	...
	//	{
	//		TODO-v4.3 Automatic balance payments with notification emails etc,
	//		TODO-v4.3 Move all of this to the calling routine
	//		$this->readGuest();
	...
	protected function setOutputForPaymentType(): void
	{
		...
		{
			//TODO-v4.3 do this properly with emails etc and add to valid payment types above
