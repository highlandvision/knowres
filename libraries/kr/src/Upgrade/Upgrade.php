...
class Upgrade
{
	...
	public static function historyTables(): void
	{
		...
		$tables = [
			'agency', 'agent', 'bedtype', 'category', 'cluster', 'contractguestdata', 'country', 'coupon', 'currency',
			'discount', 'emailtemplate', 'emailtrigger', 'exchangerate', 'extra', 'guest', 'image', 'service',
			'servicequeue', 'servicexref', 'manager', 'mapcategory', 'mapmarker', 'owner', 'property',
			'propertyfeature', 'propertyfield', 'propertyical', 'propertyoption', 'propertyroom', 'propertysetting',
			'rate', 'ratemarkup', 'referral', 'region', 'review', 'season', 'tax', 'taxrate', 'town', 'translation',
			'type'
		];
	...
	public static function importFeatures(): void
	{
		...
		$knowres_property_feature = array(
			array(
				'id'     => '1', 'name' => 'Air Conditioning', 'room_type' => array(
				'property', 'living', 'bedroom'
			), 'generic' => 'air conditioning'
			), array(
				'id'      => '2', 'name' => 'Airport Transfer', 'room_type' => array('property'),
				'generic' => 'airport pick-up service'
			), array(
				'id'      => '3', 'name' => 'Baby Listening Device', 'room_type' => array('property'),
				'generic' => 'baby listening device'
			), array(
				'id' => '4', 'name' => 'Balcony (small)', 'room_type' => array('property'), 'generic' => 'small balcony'
			), array(
				'id'      => '5', 'name' => 'Bathroom Grab Bars', 'room_type' => array('property'),
				'generic' => 'bathroom grab bars'
			), array(
				'id' => '6', 'name' => 'BBQ', 'room_type' => array('property'), 'generic' => 'bbq'
			), array(
				'id' => '7', 'name' => 'Beach View', 'room_type' => array('property'), 'generic' => 'beach view'
			), array(
				'id'      => '8', 'name' => 'Bed Linen Included', 'room_type' => array('property'),
				'generic' => 'bed linen included'
			), array(
				'id'      => '9', 'name' => 'Billiard / Pool Table', 'room_type' => array('property'),
				'generic' => 'billiard table'
			), array(
				'id'      => '10', 'name' => 'Business Centre', 'room_type' => array('property'),
				'generic' => 'business centre'
			), array(
				'id' => '11', 'name' => 'Canal View', 'room_type' => array('property'), 'generic' => 'canal view'
			), array(
				'id'      => '12', 'name' => 'Cell Phone Rentals', 'room_type' => array('property'),
				'generic' => 'cell phone rentals'
			), array(
				'id'      => '13', 'name' => 'Cleaning Weekly (free)', 'room_type' => array('property'),
				'generic' => 'free weekly cleaning'
			), array(
				'id'      => '14', 'name' => 'Central Heating', 'room_type' => array('property'),
				'generic' => 'central heating'
			), array(
				'id' => '15', 'name' => 'Concierge', 'room_type' => array('property'), 'generic' => 'concierge'
			), array(
				'id'      => '16', 'name' => 'Conference Facilities', 'room_type' => array('property'),
				'generic' => 'conference facilites'
			), array(
				'id'      => '17', 'name' => 'Cot / Crib (extra charge)', 'room_type' => array('property'),
				'generic' => 'cot extra charge'
			), array(
				'id'      => '18', 'name' => 'Cot / Crib (free on request)', 'room_type' => array('property'),
				'generic' => 'cot free on request'
			), array(
				'id' => '19', 'name' => 'Cot / Crib (free)', 'room_type' => array('property'), 'generic' => 'cot free'
			), array(
				'id' => '20', 'name' => 'Courtyard', 'room_type' => array('property'), 'generic' => 'courtyard'
			), array(
				'id'         => '21', 'name' => 'Dishwasher', 'room_type' => array(
					'property', 'kitchen'
				), 'generic' => 'dishwasher'
			), array(
				'id'      => '22', 'name' => 'Doctor on Call', 'room_type' => array('property'),
				'generic' => 'doctor on call'
			), array(
				'id'         => '23', 'name' => 'DVD Player', 'room_type' => array(
					'property', 'living'
				), 'generic' => 'dvd'
			), array(
				'id'      => '24', 'name' => 'Electronic Door Locks', 'room_type' => array('property'),
				'generic' => 'electronic door locks'
			), array(
				'id' => '25', 'name' => 'Elevator', 'room_type' => array('property'), 'generic' => 'elevator'
			), array(
				'id' => '26', 'name' => 'Fan (ceiling)', 'room_type' => array('property'), 'generic' => 'ceiling fan'
			), array(
				'id'      => '27', 'name' => 'Fans (on request)', 'room_type' => array('property'),
				'generic' => 'fans on request'
			), array(
				'id'         => '28', 'name' => 'Fireplace', 'room_type' => array(
					'property', 'living', 'bedroom'
				), 'generic' => 'fireplace'
			), array(
				'id'      => '29', 'name' => 'Fireplace Wood Burning', 'room_type' => array('property'),
				'generic' => 'wood burning fireplace'
			), array(
				'id' => '30', 'name' => 'Fitness Room', 'room_type' => array('property'), 'generic' => 'fitness room'
			), array(
				'id' => '31', 'name' => 'Freezer', 'room_type' => array('property'), 'generic' => 'freezer'
			), array(
				'id'         => '32', 'name' => 'Fridge Freezer', 'room_type' => array(
					'property', 'kitchen'
				), 'generic' => 'fridge freezer'
			), array(
				'id' => '33', 'name' => 'Games Room', 'room_type' => array('property'), 'generic' => 'games room'
			), array(
				'id'      => '34', 'name' => 'Garden (shared)', 'room_type' => array('property'),
				'generic' => 'garden shared'
			), array(
				'id'      => '35', 'name' => 'Garden (private)', 'room_type' => array('property'),
				'generic' => 'garden private'
			), array(
				'id' => '36', 'name' => 'Gym', 'room_type' => array('property'), 'generic' => 'gym for guest use'
			), array(
				'id' => '37', 'name' => 'Hair Dryer', 'room_type' => 'property,bathroom', 'generic' => 'hair dryer'
			), array(
				'id' => '38', 'name' => 'Health Club', 'room_type' => array('property'), 'generic' => 'health club'
			), array(
				'id' => '39', 'name' => 'Help Desk', 'room_type' => array('property'), 'generic' => 'help desk'
			), array(
				'id' => '40', 'name' => 'Hi-fi', 'room_type' => array('property'), 'generic' => 'stereo'
			), array(
				'id' => '41', 'name' => 'High Chair', 'room_type' => array('property'), 'generic' => 'high chair'
			), array(
				'id'      => '42', 'name' => 'Hot Tub (shared)', 'room_type' => array('property'),
				'generic' => 'hot tub shared'
			), array(
				'id'      => '43', 'name' => 'Hot Tub (private)', 'room_type' => array('property'),
				'generic' => 'hot tub private'
			), array(
				'id'      => '44', 'name' => 'Internet Access (free)', 'room_type' => array('property'),
				'generic' => 'internet access free'
			), array(
				'id'      => '45', 'name' => 'Internet Access (high speed)', 'room_type' => array('property'),
				'generic' => 'internet access high speed'
			), array(
				'id'      => '46', 'name' => 'Internet Cable (extra charge)', 'room_type' => array('property'),
				'generic' => 'internet cable paid'
			), array(
				'id'      => '47', 'name' => 'Internet Cable (free)', 'room_type' => array('property'),
				'generic' => 'internet cable free'
			), array(
				'id'      => '48', 'name' => 'Internet Connection', 'room_type' => array('property'),
				'generic' => 'internet connection'
			), array(
				'id'      => '49', 'name' => 'Internet WiFi (extra charge)', 'room_type' => array('property'),
				'generic' => 'internet wifi paid'
			), array(
				'id'      => '50', 'name' => 'Internet Wifi (free )', 'room_type' => array('property'),
				'generic' => 'internet wifi free'
			), array(
				'id' => '51', 'name' => 'Iron', 'room_type' => array('property'), 'generic' => 'iron'
			), array(
				'id' => '52', 'name' => 'Iron & Board', 'room_type' => array('property'), 'generic' => 'iron and board'
			), array(
				'id' => '53', 'name' => 'Ironing Board', 'room_type' => array('property'), 'generic' => 'ironing board'
			), array(
				'id'      => '54', 'name' => 'Laundry (shared)', 'room_type' => array('property'),
				'generic' => 'laundry shared'
			), array(
				'id'      => '55', 'name' => 'Laundry (private)', 'room_type' => array('property'),
				'generic' => 'laundry private'
			), array(
				'id' => '56', 'name' => 'Lounge', 'room_type' => array('property'), 'generic' => 'lounge'
			), array(
				'id'      => '57', 'name' => 'Luggage Storage Facilities', 'room_type' => array('property'),
				'generic' => 'luggage storage facilities'
			), array(
				'id'      => '58', 'name' => 'Weekly Maid Service', 'room_type' => array('property'),
				'generic' => 'weekly maid service'
			), array(
				'id' => '59', 'name' => 'Maid Service', 'room_type' => array('property'), 'generic' => 'maid service'
			), array(
				'id' => '60', 'name' => 'Ocean View', 'room_type' => array('property'), 'generic' => 'ocean view'
			), array(
				'id' => '61', 'name' => 'Parking Free', 'room_type' => array('property'), 'generic' => 'parking free'
			), array(
				'id'      => '62', 'name' => 'Parking Guarded', 'room_type' => array('property'),
				'generic' => 'parking guarded'
			), array(
				'id'      => '63', 'name' => 'Parking On Street ', 'room_type' => array('property'),
				'generic' => 'parking on street'
			), array(
				'id'      => '64', 'name' => 'Parking Private', 'room_type' => array('property'),
				'generic' => 'parking private'
			), array(
				'id'      => '65', 'name' => 'Parking Underground', 'room_type' => array('property'),
				'generic' => 'underground parking'
			), array(
				'id'      => '66', 'name' => 'Pets Not Allowed', 'room_type' => array('property'),
				'generic' => 'pets not allowed'
			), array(
				'id' => '67', 'name' => 'Pets Welcome', 'room_type' => array('property'), 'generic' => 'pets welcome'
			), array(
				'id' => '68', 'name' => 'Safe', 'room_type' => array('property'), 'generic' => 'safe',
			), array(
				'id' => '69', 'name' => 'Sauna', 'room_type' => array('property'), 'generic' => 'sauna'
			), array(
				'id' => '70', 'name' => 'Sea View', 'room_type' => array('property'), 'generic' => 'sea view'
			), array(
				'id'      => '71', 'name' => 'Smoking Permitted', 'room_type' => array('property'),
				'generic' => 'smoking permitted'
			), array(
				'id' => '72', 'name' => 'Steam Bath', 'room_type' => array('property'), 'generic' => 'steam bath'
			), array(
				'id' => '73', 'name' => 'Steam Room', 'room_type' => array('property'), 'generic' => 'steam room'
			), array(
				'id' => '74', 'name' => 'Swimming Pool', 'room_type' => array('property'), 'generic' => 'swimming pool'
			), array(
				'id'      => '75', 'name' => 'Swimming Pool (Heated )', 'room_type' => array('property'),
				'generic' => 'swimming pool heated'
			), array(
				'id'      => '76', 'name' => 'Swimming Pool (indoor )', 'room_type' => array('property'),
				'generic' => 'swimming pool indoor'
			), array(
				'id' => '77', 'name' => 'Telephone', 'room_type' => array('property'), 'generic' => 'telephone'
			), array(
				'id'      => '78', 'name' => 'Telephone (free local calls)', 'room_type' => array('property'),
				'generic' => 'telephone free local calls'
			), array(
				'id' => '79', 'name' => 'Tennis Court', 'room_type' => array('property'), 'generic' => 'tennis court'
			), array(
				'id' => '80', 'name' => 'Terrace', 'room_type' => array('property'), 'generic' => 'terrace'
			), array(
				'id'         => '81', 'name' => 'Toiletries', 'room_type' => array(
					'property', 'bathroom'
				), 'generic' => 'toiletries'
			), array(
				'id'      => '82', 'name' => 'Towels Included', 'room_type' => array('property'),
				'generic' => 'towels included'
			), array(
				'id' => '83', 'name' => 'TV (cable)', 'room_type' => array('property'), 'generic' => 'tv cable'
			), array(
				'id'      => '84', 'name' => 'TV (local channels only)', 'room_type' => array('property'),
				'generic' => 'tv local channels only'
			), array(
				'id' => '85', 'name' => 'TV (satellite)', 'room_type' => array('property'), 'generic' => 'tv satellite'
			), array(
				'id'      => '86', 'name' => 'Vacuum Cleaner', 'room_type' => array('property'),
				'generic' => 'vacuum cleaner'
			), array(
				'id'      => '87', 'name' => 'Washing Machine', 'room_type' => 'property,bathroom,kitchen',
				'generic' => 'washing machine'
			), array(
				'id'         => '88', 'name' => 'Washer Dryer', 'room_type' => array(
					'property', 'bathroom', 'kitchen'
				), 'generic' => 'washer dryer'
			), array(
				'id'      => '89', 'name' => 'Video Game System', 'room_type' => array('property'),
				'generic' => 'video game system'
			), array(
				'id'      => '90', 'name' => 'Wheelchair Access', 'room_type' => array('property'),
				'generic' => 'wheelchair access'
			), array(
				'id'      => '91', 'name' => 'Laundry Service', 'room_type' => array('property'),
				'generic' => 'laundry service'
			), array(
				'id' => '92', 'name' => 'Parking', 'room_type' => array('property'), 'generic' => 'parking'
			), array(
				'id' => '93', 'name' => 'Near the Beach', 'room_type' => array('property'), 'generic' => 'beach'
			), array(
				'id'      => '94', 'name' => 'No Smoking', 'room_type' => array('property'),
				'generic' => 'no smoking rooms/facilities'
			), // Non-general
			array(
				'id' => '1001', 'name' => 'Alarm Clock', 'room_type' => array('bedroom'), 'generic' => 'alarm clock'
			), array(
				'id'         => '1002', 'name' => 'Armchair', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'armchair'
			), array(
				'id' => '1003', 'name' => 'Balcony', 'room_type' => 'living,bedroom', 'generic' => 'balcony'
			), array(
				'id' => '1004', 'name' => 'Bathtub', 'room_type' => array('bathroom'), 'generic' => 'bathtub'
			), array(
				'id'         => '1005', 'name' => 'Bed Double', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'double bed'
			), array(
				'id'         => '1006', 'name' => 'Bed King', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'king size bed'
			), array(
				'id'         => '1007', 'name' => 'Bed Queen', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'queen size bed'
			), array(
				'id' => '1008', 'name' => 'Bed Single', 'room_type' => 'living,bedroom', 'generic' => 'single bed'
			), array(
				'id' => '1009', 'name' => 'Beds Bunk', 'room_type' => 'living,bedroom', 'generic' => 'bunk beds'
			), array(
				'id'         => '1010', 'name' => 'Beds Twin', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'pair of twin beds'
			), array(
				'id' => '1011', 'name' => 'Bedside Table', 'room_type' => array('bedroom'), 'generic' => 'night table'
			), array(
				'id'         => '1012', 'name' => 'Bidet', 'room_type' => array(
					'wc', 'bathroom'
				), 'generic' => 'bidet'
			), array(
				'id' => '1013', 'name' => 'Blender', 'room_type' => array('kitchen'), 'generic' => 'blender'
			), array(
				'id'      => '1014', 'name' => 'Breakfast Bar & Stools', 'room_type' => array('kitchen'),
				'generic' => 'breakfast bar and stools'
			), array(
				'id'      => '1015', 'name' => 'Built In Wardrobes', 'room_type' => array('bedroom'),
				'generic' => 'built-in wardrobes'
			), array(
				'id'         => '1016', 'name' => 'Chair', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'chair'
			), array(
				'id'         => '1017', 'name' => 'Chest of Drawers', 'room_type' => array(
					'wc', 'bathroom', 'bedroom'
				), 'generic' => 'chest of drawers'
			), array(
				'id' => '1018', 'name' => 'Coffee Maker', 'room_type' => 'kitchen', 'generic' => 'coffee maker'
			), array(
				'id' => '1019', 'name' => 'Coffee Table', 'room_type' => array('living'), 'generic' => 'coffee table'
			), array(
				'id' => '1020', 'name' => 'Cooker / Stove', 'room_type' => array('kitchen'), 'generic' => 'cooker'
			), array(
				'id'      => '1021', 'name' => 'Cookware & Utensils', 'room_type' => array('kitchen'),
				'generic' => 'cookware and kitchen utensils'
			), array(
				'id'      => '1022', 'name' => 'Crockery & Cutlery', 'room_type' => array('kitchen'),
				'generic' => 'crockery and cutlery'
			), array(
				'id' => '1023', 'name' => 'Cupboards', 'room_type' => array('kitchen'), 'generic' => 'cupboards'
			), array(
				'id' => '1024', 'name' => 'Cupboard', 'room_type' => array('bathroom'), 'generic' => 'cupboard'
			), array(
				'id'         => '1025', 'name' => 'Desk', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'desk'
			), array(
				'id'      => '1026', 'name' => 'Electric Kettle', 'room_type' => array('kitchen'),
				'generic' => 'electric kettle'
			), array(
				'id'      => '1027', 'name' => 'En Suite Bathroom', 'room_type' => array('bedroom'),
				'generic' => 'en suite bathroom'
			), array(
				'id'      => '1028', 'name' => 'En Suite Shower', 'room_type' => array('bedroom'),
				'generic' => 'en suite shower'
			), array(
				'id'      => '1029', 'name' => 'Espresso Machine', 'room_type' => array('kitchen'),
				'generic' => 'espresso-machine'
			), array(
				'id' => '1030', 'name' => 'Fan', 'room_type' => array('living'), 'generic' => 'fan'
			), array(
				'id' => '1031', 'name' => 'Fridge', 'room_type' => array('kitchen'), 'generic' => 'fridge'
			), array(
				'id'         => '1032', 'name' => 'Heated Towel Rail', 'room_type' => array(
					'wc', 'bathroom'
				), 'generic' => 'heated towel bar'
			), array(
				'id' => '1033', 'name' => 'Heating', 'room_type' => array('living'), 'generic' => 'heating'
			), array(
				'id'      => '1034', 'name' => 'Hob (Electric)', 'room_type' => array('kitchen'),
				'generic' => 'gas or electric hob'
			), array(
				'id'      => '1035', 'name' => 'Hob (Gas)', 'room_type' => array('kitchen'),
				'generic' => 'gas or electric hob'
			), array(
				'id' => '1036', 'name' => 'Ice Maker', 'room_type' => array('kitchen'), 'generic' => 'ice maker'
			), array(
				'id' => '1037', 'name' => 'Jacuzzi', 'room_type' => array('bathroom'), 'generic' => 'jacuzzi'
			), array(
				'id' => '1038', 'name' => 'Kettle', 'room_type' => array('kitchen'), 'generic' => 'kettle'
			), array(
				'id' => '1039', 'name' => 'Microwave', 'room_type' => array('kitchen'), 'generic' => 'microwave'
			), array(
				'id'         => '1040', 'name' => 'Mirror', 'room_type' => array(
					'wc', 'bathroom', 'bedroom'
				), 'generic' => 'mirror'
			), array(
				'id' => '1041', 'name' => 'Oven', 'room_type' => array('kitchen'), 'generic' => 'oven'
			), array(
				'id'         => '1042', 'name' => 'Reading Lamp', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'reading lamp'
			), array(
				'id' => '1043', 'name' => 'Shower', 'room_type' => array('bathroom'), 'generic' => 'shower'
			), array(
				'id'      => '1044', 'name' => 'Sofa Bed (double)', 'room_type' => 'living,bedroom',
				'generic' => 'double sofa bed'
			), array(
				'id'         => '1045', 'name' => 'Sofa Bed (single)', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'sofabed'
			), array(
				'id' => '1046', 'name' => 'Sofa (large)', 'room_type' => array('living'), 'generic' => 'sofa'
			), array(
				'id'         => '1047', 'name' => 'Sofa (small)', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'double sofa'
			), array(
				'id'         => '1048', 'name' => 'Table', 'room_type' => array(
					'kitchen', 'living', 'bedroom'
				), 'generic' => 'table'
			), array(
				'id'         => '1049', 'name' => 'Table Lamp', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'lamp'
			), array(
				'id'         => '1050', 'name' => 'Table & Chairs', 'room_type' => array(
					'kitchen', 'living', 'bedroom'
				), 'generic' => 'table and chairs'
			), array(
				'id' => '1051', 'name' => 'Toaster', 'room_type' => array('kitchen'), 'generic' => 'toaster'
			), array(
				'id'         => '1052', 'name' => 'Toilet', 'room_type' => array(
					'wc', 'bathroom'
				), 'generic' => 'toilet'
			), array(
				'id'         => '1053', 'name' => 'TV', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'tv'
			), array(
				'id'         => '1054', 'name' => 'TV (flat screen)', 'room_type' => array(
					'living', 'bedroom'
				), 'generic' => 'tv'
			), array(
				'id'      => '1055', 'name' => 'Vanity Unit', 'room_type' => array('bathroom'),
				'generic' => 'vanity cupboard'
			), array(
				'id' => '1056', 'name' => 'Wardrobe', 'room_type' => array('bedroom'), 'generic' => 'wardrobe'
			), array(
				'id'         => '1057', 'name' => 'Washbasin', 'room_type' => array(
					'wc', 'bathroom'
				), 'generic' => 'washbasin',
			), array(
				'id'      => '1058', 'name' => 'Combo Tub Shower', 'room_type' => array('bathroom'),
	...
	protected static function historyUpdate(object $table, string $name, string $title, string $alias): void
	{
		...
		if (!$contentType->load(array('type_alias' => $alias)))
		{
			...
			$contentType->table      = Utility::encodeJson(array(
				'special' => array(
					'dbtable' => $table->getTableName(), 'key' => $table->getKeyName(), 'type' => ucfirst($name),
					'prefix'  => 'KnowresTable'
				)
			));
