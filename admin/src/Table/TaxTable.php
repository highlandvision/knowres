 ...
 * @since 2.5.0
 */
class TaxTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.tax';
		parent::__construct('#__knowres_tax', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$Translations->deleteText('tax', $pk);
		}
