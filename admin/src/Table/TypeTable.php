...
/**
 * Table class for type
 *
 * @since 1.0.0
 */
class TypeTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.type';
		parent::__construct('#__knowres_type', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$translation->deleteText('type', $pk);
		}
