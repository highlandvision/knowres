 ...
 * @since 1.0.0
 */
class CountryTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.country';
		parent::__construct('#__knowres_country', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$translation->deleteText('country', $pk);
		}
