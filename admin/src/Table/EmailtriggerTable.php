...
/**
 * Knowres Email trigger Table
 *
 * @since    1.0.0
 */
class EmailtriggerTable extends Table implements VersionableTableInterface
{
	/** @var array An array of key names to be json encoded in the bind function */
	protected $_jsonEncode = ['booking_status'];
	...
	{
		$this->typeAlias = 'com_knowres.emailtrigger';
		parent::__construct('#__knowres_email_trigger', 'id', $db);
