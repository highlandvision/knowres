...
/**
 * Knowres Service queue Table
 *
 * @since    1.0.0
 */
class ServicequeueTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.servicequeue';
		parent::__construct('#__knowres_service_queue', 'id', $db);
