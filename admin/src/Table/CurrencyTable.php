 ...
 * @since 1.0.0
 */
class CurrencyTable extends Table implements VersionableTableInterface
{
	/** @var array An array of key names to be json encoded in the bind function */
	protected $_jsonEncode = ['allow_payment'];
	...
	{
		$this->typeAlias = 'com_knowres.currency';
		parent::__construct('#__knowres_currency', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$translation->deleteText('currency', $pk);
		}
