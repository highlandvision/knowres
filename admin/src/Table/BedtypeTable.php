 ...
 * @since 1.0.0
 */
class BedTypeTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.bed_type';
		parent::__construct('#__knowres_bed_type', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$Translations->deleteText('bedtype', $pk);
		}
