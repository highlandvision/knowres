 ...
 * @since 1.0.0
 */
class RateTable extends Table implements VersionableTableInterface
{
	/** @var array An array of key names to be json encoded in the bind function */
	protected $_jsonEncode = ['more_guests'];
	...
	{
		$this->typeAlias = 'com_knowres.rate';
		parent::__construct('#__knowres_rate', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$translation->deleteText('rate', $pk);
		}
