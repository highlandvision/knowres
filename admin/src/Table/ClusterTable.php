 ...
 * @since 1.0.0
 */
class ClusterTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.cluster';
		parent::__construct('#__knowres_cluster', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$translation->deleteText('cluster', $pk);
		}
