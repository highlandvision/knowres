...
/**
 * Property fields controller list class.
 *
 * @since 1.0.0
 */
class PropertyfieldsController extends AdminController
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 */
	public function getModel($name = 'propertyfield', $prefix = 'Administrator',
