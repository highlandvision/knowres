...
/**
 * Map categories controller list class.
 *
 * @since 1.0.0
 */
class MapcategoriesController extends AdminController
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 */
	public function getModel($name = 'mapcategory', $prefix = 'Administrator',
