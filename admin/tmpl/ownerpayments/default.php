...
/** @var HighlandVision\Component\Knowres\Administrator\View\Ownerpayments\HtmlView $this */

$wa = $this->document->getWebAssetManager();
$wa->useScript('keepalive')
   ->useScript('form.validate')
   ->useScript('com_knowres.admin-ownerpayment')
   ->useStyle('com_knowres.admin-ownerpayment');
