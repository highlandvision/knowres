	...
	<tr class="row<?php echo $i % 2; ?>;">
		...
		<th scope="row">
			<?php echo KrMethods::render('html.list.editable',
				['data' => $this, 'item' => $this->item, 'i' => $i, 'column' => 'guest_name']); ?>
		</th>
		<td class="text-center d-none d-md-table-cell">
			<?php echo $this->item->approved ? KrMethods::plain('JYES') : KrMethods::plain('JNO'); ?>
		</td>
		<td class="text-center d-none d-md-table-cell">
			<?php echo $this->item->held ? KrMethods::plain('JYES') : KrMethods::plain('JNO'); ?>
		</td>
		<td class="d-none d-md-table-cell">
			<?php echo TickTock::displayDate($this->item->review_date, 'd M Y'); ?>
		</td>
		<td class="d-none d-md-table-cell">
