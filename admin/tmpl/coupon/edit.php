...
/** @var HighlandVision\Component\Knowres\Administrator\View\Coupon\HtmlView $this */
...
<form action="<?php echo KrMethods::route('index.php?option=com_knowres&layout=edit&id=' . (int) $this->item->id); ?>"
      aria-label="<?php echo $this->form_aria_label; ?>" class="form-validate" id="coupon-form" method="post"
      name="adminForm">
