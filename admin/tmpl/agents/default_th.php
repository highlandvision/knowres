...
<tr>
	...
	<th scope="col" class='w-25 d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_AGENTS_SERVICE_ID', 'service_name', $this->listDirn,
			$this->listOrder); ?>
	</th>
	<th scope="col" class="w-5 d-none d-md-table-cell">
		<?php echo HTMLHelper::_('searchtools.sort', 'JGRID_HEADING_ID', 'a.id', $this->listDirn,
			$this->listOrder); ?>
	</th>
</tr>