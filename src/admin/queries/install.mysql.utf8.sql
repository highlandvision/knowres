...
(
    ...
    `mandatory_extras_charge` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `mandatory_extras_excluded` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `deposit` DECIMAL
...
(
    ...
    `deposit_unconfirmed` DECIMAL
(
    11,
    4
) NOT NULL DEFAULT 0.0000,
    `deposit_unconfirmed_agent` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `expiry_days` VARCHAR
(
    ...
    `balance_days` VARCHAR
(
    3
) DEFAULT NULL,
    `agent_markup` DECIMAL
(
    11,
    4
) NOT NULL DEFAULT 0.0000,
...
(
    ...
    `foreign_key_reqd` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `owner_deposit_payment` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `state` TINYINT
...
(
    ...
    `deposit_system` DECIMAL
(
    11,
    2
) NOT NULL DEFAULT 0.00,
    `room_total_gross` DECIMAL
(
    11,
    2
) NOT NULL DEFAULT 0.00,
    `room_total_gross_system` DECIMAL
(
    11,
    2
) NOT NULL DEFAULT 0.00,
...
(
    ...
    `departure_means` VARCHAR
(
    255
) DEFAULT NULL,
    `departure_number` VARCHAR
(
    255
) DEFAULT NULL,
...
(
    ...
    `trigger_actual` VARCHAR
(
    255
) DEFAULT NULL,
    `trigger_cron` VARCHAR
(
    255
) DEFAULT NULL,
    `days` INT
...
(
    ...
    KEY `byPropertyArrival`
(
    `property_id`,
    `arrival`
),
    KEY `byServiceProperty`
(
    `service_id`,
    `property_id`,
    `arrival`
...
(
    ...
    `property_aka` VARCHAR
(
    255
) DEFAULT NULL,
    `property_street` VARCHAR
(
    255
) DEFAULT NULL,
...
(
    ...
    `sleeps_extra` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `sleeps_infant_age` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `sleeps_infant_max` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `pets` TINYINT
...
(
    ...
    `contact_days` TINYINT
(
    1
) NOT NULL DEFAULT 0,
    `property_videolink` VARCHAR
(
    255
) DEFAULT NULL,
    `cancellation_penalty` TEXT DEFAULT NULL,
    `security_cash` TINYINT
(
    1
) NOT NULL DEFAULT 0,
...
(
    ...
    KEY `byServicePropertyMethod`
(
    `service_id`,
    `property_id`,
    `method`
),
    KEY `byPropertyServiceMethod`
(
    `property_id`,
    `service_id`,
    `method`
