...
/**
 * Email triggers controller list class.
 *
 * @since 1.0.0
 */
class EmailtriggersController extends AdminController
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 */
	public function getModel($name = 'emailtrigger', $prefix = 'Administrator',
