...
/**
 * Services controller list class.
 *
 * @since 1.0.0
 */
class ServicesController extends AdminController
{
	 ...
	 * @since   1.6
	 */
	#[NoReturn] public function new(): void
	{
		$view = $this->getView('services', 'new');
		$view->display();
	}
	 ...
	 */
	public function getModel($name = 'service', $prefix = 'Administrator',
