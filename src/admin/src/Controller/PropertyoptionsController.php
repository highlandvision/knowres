...
/**
 * Property optionscontroller list class.
 *
 * @since 1.0.0
 */
class PropertyoptionsController extends AdminController
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 */
	public function getModel($name = 'propertyoption', $prefix = 'Administrator',
