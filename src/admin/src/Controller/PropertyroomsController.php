...
/**
 * Property rooms controller list class.
 *
 * @since 1.0.0
 */
class PropertyroomsController extends AdminController
{
	/**
	 * Proxy for getModel.
	 *
	 ...
	 */
	public function getModel($name = 'propertyroom', $prefix = 'Administrator',
