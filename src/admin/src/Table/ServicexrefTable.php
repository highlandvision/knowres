...
/**
 * Knowres Service xref Table
 *
 * @since    1.0.0
 */
class ServicexrefTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.servicexref';
		parent::__construct('#__knowres_service_xref', 'id', $db);
