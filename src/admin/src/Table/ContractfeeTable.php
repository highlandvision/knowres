...
/**
 * Contract fee Table class
 *
 * @since 1.0.0
 */
class ContractfeeTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.contractfee';
		parent::__construct('#__knowres_contract_fee', 'id', $db);
