 ...
 * @since 1.0.0
 */
class ManagerTable extends Table implements VersionableTableInterface
{
	/** @var array An array of key names to be json encoded in the bind function */
	protected $_jsonEncode = ['properties'];
	...
	{
		$this->typeAlias = 'com_knowres.manager';
		parent::__construct('#__knowres_manager', 'id', $db);
