 ...
 * @since 1.0.0
 */
class ExtraTable extends Table implements VersionableTableInterface
{
    ...
    {
        $this->typeAlias = 'com_knowres.extra';
        parent::__construct('#__knowres_extra', 'id', $db);
    ...
    public function delete($pk = null): bool
    {
        ...
        if ($result) {
            ...
            $Translations->deleteText('extra', $pk);
        }
