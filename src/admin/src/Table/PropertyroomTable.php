...
/**
 * Knowres Property room Table
 *
 * @since    1.0.0
 */
class PropertyroomTable extends Table implements VersionableTableInterface
{
	/** @var array An array of key names to be json encoded in the bind function */
	protected $_jsonEncode = ['features'];
	...
	{
		$this->typeAlias = 'com_knowres.propertyroom';
		parent::__construct('#__knowres_property_room', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$translation->deleteText('propertyroom', $pk);
		}
