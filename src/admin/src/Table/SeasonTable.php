 ...
 * @since 1.0.0
 */
class SeasonTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_knowres.season';
		parent::__construct('#__knowres_season', 'id', $db);
	...
	public function delete($pk = null): bool
	{
		...
		if ($result)
		{
			...
			$translation->deleteText('season', $pk);
		}
