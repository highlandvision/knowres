...
namespace HighlandVision\Component\Knowres\Administrator\View\Discounts;

defined('_JEXEC') or die;

use Exception;
use HighlandVision\Component\Knowres\Administrator\Model\DiscountsModel;
...
class HtmlView extends KrHtmlView\Property
{
	...
	public function display($tpl = null): void
	{
		...
		$this->form_name     = 'discount';

		if (!$this->checkEmpty())
		{
			$this->checkErrors();
			$title = KrMethods::plain('COM_KNOWRES_DISCOUNTS_TITLE') . ' - ' . $this->property_name;
