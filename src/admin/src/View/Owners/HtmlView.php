...
namespace HighlandVision\Component\Knowres\Administrator\View\Owners;

defined('_JEXEC') or die;

use Exception;
use HighlandVision\Component\Knowres\Administrator\Model\OwnersModel;
