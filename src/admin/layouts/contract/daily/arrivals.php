...
<div class="table-responsive">
    <table class="table table-sm">
        ...
        <?php foreach ($lines as $l): ?>
            <?php
            $link  = KrMethods::route('index.php?option=com_knowres&task=property.dashboard&id=' . $l['id']);
            $plink = KrMethods::route('index.php?option=com_knowres&task=property.dashboard&id=' . $l['property_id']);
            ?>
