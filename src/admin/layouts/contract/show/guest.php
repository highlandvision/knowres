...
<div class="row">
    <div class="col-lg-6">
        <div class="fw500">
            <?php echo $guest->firstname . ' ' . $guest->surname; ?>
        </div>
        <address>
            <?php echo Utility::formatAddress(
                $guest->address1, $guest->address2, $guest->postcode, $guest->town,
        ...
        <address>
            <?php echo Utility::formatAddress(
                $guest->b_address1, $guest->b_address2, $guest->b_postcode,
        ...
        <?php if ($document_id && !empty($guest->document_id) && !empty($guest->document_type)) : ?>
            <div class="fw500">
                ...
                $model = KrFactory::getAdminModel('contractguestdata');
                echo $model::getDocumentType($guest->document_type);
                ?>
            </div>
    ...
    <div class="col-lg-6">
        ...
        <?php elseif ($contract->children > 1) : ?>
            <?php echo KrMethods::sprintf(
                'COM_KNOWRES_CONTRACT_CHILDREN', $contract->children,
