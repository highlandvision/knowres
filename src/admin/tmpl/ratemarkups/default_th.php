...
<tr>
	...
	<th class='w-10'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_RATEMARKUPS_PROPERTY_ID', 'property_name',
			$this->listDirn, $this->listOrder); ?>
	</th>
	<th class='w-10'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_RATEMARKUPS_VALID_FROM', 'a.valid_from',
			$this->listDirn, $this->listOrder); ?>
	</th>
	<th class='w-10 d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_RATEMARKUPS_VALID_TO', 'a.valid_to', $this->listDirn,
			$this->listOrder); ?>
	</th>
	<th class='w-10 d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_RATEMARKUPS_NET_MARKUP', 'a.net_markup',
			$this->listDirn, $this->listOrder); ?>
	</th>
