...
<tr>
	...
	<th scope="col" class='w-15 d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_SEASONS_VALID_FROM', 'a.valid_from',
			$this->listDirn, $this->listOrder); ?>
	</th>
	<th scope="col" class='w-15 d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_SEASONS_VALID_TO', 'a.valid_to',
			$this->listDirn, $this->listOrder); ?>
	</th>
	<th scope="col" class='w-5 d-none d-md-table-cell text-center'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_SEASONS_MINIMUM_NIGHTS',
			'a.minimum_nights', $this->listDirn, $this->listOrder); ?>
	</th>
	<th scope="col" class='w-15 d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_SEASONS_SEASON', 'a.season',
			$this->listDirn, $this->listOrder); ?>
	</th>
	<th scope="col" class='w-15 d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_SEASONS_CLUSTER_ID', 'cluster_name',
			$this->listDirn, $this->listOrder); ?>
	</th>
