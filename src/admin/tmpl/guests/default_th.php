...
<tr>
    ...
    <th scope="col" class="w-15">
        <?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_NAME', 'a.surname', $this->listDirn,
            $this->listOrder,
        ); ?>
    </th>
    <th class='w-15 d-none d-md-table-cell'>
        <?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_GUESTS_FIRSTNAME', 'a.firstname', $this->listDirn,
            $this->listOrder,
        ); ?>
    </th>
    <th class='w-20 d-none d-md-table-cell'>
        <?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_EMAIL', 'a.email', $this->listDirn,
            $this->listOrder,
        ); ?>
    </th>
