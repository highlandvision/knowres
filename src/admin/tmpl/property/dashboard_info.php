...
$date = KrFactory::getListModel('rates')
                 ->getLastRateDate($this->item->id);
?>
    ...
    <div class="row">
        ...
        <?php if ($this->access_level > 10 || ($this->access_level == 10
...
<?php if ($this->settings['net_rates'] && $this->access_level > 10): ?>
    <div class="row">
        ...
        <div class="col-md-5">
            <?php echo KrMethods::sprintf('COM_KNOWRES_CURRENT', (int) $this->item->ratemarkups); ?>
        </div>
        <div class="col-md-2">
