...
if (!$this->item->cancelled) {
    echo $this->loadTemplate('modal_quickedit');
} else {
    echo $this->loadTemplate('modal_resurrect');
}
if ($this->xero) {
    echo $this->loadTemplate('xero');
}

KrMethods::render('contract.modal.error');
?>

<form id="contract-form" method="post" name="adminForm"
