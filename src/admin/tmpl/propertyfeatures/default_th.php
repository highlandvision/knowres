...
<tr>
	...
	<th scope="col" class='w-5  d-none d-md-table-cell text-center'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_PROPERTYFEATURES_FILTER', 'a.filter', $this->listDirn,
			$this->listOrder); ?>
	</th>
	<th scope="col" class="w-20 d-none d-md-table-cell">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_PROPERTYFEATURES_GENERIC', 'a.generic',
			$this->listDirn, $this->listOrder); ?>
	</th>
	<th scope="col" class="w-20 d-none d-md-table-cell">
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_PROPERTYFEATURES_ROOM_TYPE', 'a.room_type',
			$this->listDirn, $this->listOrder); ?>
	</th>
