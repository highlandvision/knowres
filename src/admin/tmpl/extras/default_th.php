...
<tr>
	...
	<th class='w-5 text-center d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_EXTRAS_MANDATORY', 'a.mandatory', $this->listDirn,
			$this->listOrder); ?>
	</th>
	...
	<th class='w-20 d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_EXTRAS_MODEL', 'a.model', $this->listDirn,
			$this->listOrder); ?>
	</th>
	<th class='w-10 text-center d-none d-md-table-cell'>
		<?php echo HTMLHelper::_('searchtools.sort', 'COM_KNOWRES_EXTRAS_MAX_QUANTITY', 'a.max_quantity',
