...
abstract class Service
{
    ...
    protected function readContract(): void
    {
        ...
        $this->contract = KrFactory::getAdminItem('contract', $this->contract_id);
        if (!$this->contract->id) {
    ...
    protected function readGuest(): void
    {
        ...
        $this->guest = KrFactory::getAdminItem('guest', $this->contract->guest_id);
        if (!$this->guest->id) {
    ...
    protected function readOwner(): void
    {
        if (!$this->property->owner_id) {
            throw new InvalidArgumentException(
                'Property ' . $this->property->property_name . ' does not have an owner assigned',
            );
        }

        $this->owner = KrFactory::getAdminItem('owner', $this->property->owner_id);
        if (!$this->owner->id) {
    ...
    protected function readProperty(int $property_id): void
    {
        ...
        $this->property = KrFactory::getAdminItem('property', $property_id);
    ...
    {
        $this->service = KrFactory::getAdminItem('service', $this->service_id);
