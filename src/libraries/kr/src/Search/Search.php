...
class Search
{
    ...
    private function checkGuestNumbers(array $items): void
    {
        ...
        foreach ($items as $item) {
            ...
            $free = SiteHelper::setFreeGuests($item->sleeps_infant_max,
                $item->sleeps_infant_age, $this->searchData->child_ages,
            );
    ...
    {
        $rates =
            $this->setForProperty(KrFactory::getListModel('rates')->getRatesForProperty(
                $this->searchData->baseIds, $this->searchData->arrival, $this->searchData->departure,
            ),
            );
    ...
    private function validateRegion(): void
    {
        ...
        $this->searchData->map_zoom     = $region->map_zoom;
        $this->searchData->map_zoom_max = $region->map_zoom_max;
    }
}