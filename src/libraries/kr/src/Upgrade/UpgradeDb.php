...
class UpgradeDb
{
    ...
    public static function forV510(): void
    {
        ...
        // DROP TABLE `#__knowres_referral`;
        self::dropTable($db, '#__knowres_referral');
        //ALTER TABLE `#__knowres_email_trigger` CHANGE `send_agent` `send_agency` TINYINT(1) DEFAULT 0;
        self::change($db, '#__knowres_email_trigger', 'send_agent', 'send_agency', 'TINYINT(1) DEFAULT 0');
    }
     ...
     * @since  5.2.0
     */
    public static function forV520(): void
    {
        $db = KrFactory::getDatabase();

        // Catch any not updated in V510
        //ALTER TABLE `#__knowres_email_trigger` CHANGE `send_agent` `send_agency` TINYINT(1) DEFAULT 0;
        self::change($db, '#__knowres_email_trigger', 'send_agent', 'send_agency', 'TINYINT(1) DEFAULT 0');
        // DROP TABLE `#__knowres_referral`;
        self::dropTable($db, '#__knowres_referral');
