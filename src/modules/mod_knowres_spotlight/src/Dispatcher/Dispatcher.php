...
namespace HighlandVision\Module\KnowresSpotlight\Site\Dispatcher;
...
/**
 * Dispatcher class for mod_knowres_spotlight
 *
 * @since  4.0.0
 */
class Dispatcher extends AbstractModuleDispatcher implements HelperFactoryAwareInterface
{
	...
	protected function getLayoutData(): array
	{
		...
		if ($data && !empty($params)) {
			$Helper                = $this->getHelperFactory()->getHelper('KnowresSpotlightHelper');
