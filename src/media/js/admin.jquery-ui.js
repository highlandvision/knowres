...
(function (e) {
	...
	e.extend(n.prototype, {
		...
		parseDate: function parseDate(t, i, s) {
			...
			if (i = "object" == (typeof i === "undefined" ? "undefined" : _typeof(i)) ? "" + i : i + "", "" === i) {
				return null;
			}
		...
		_generateHTML: function _generateHTML(e) {
			...
			if (0 > Z && (Z += 12, et--), $) {
				for (t = this._daylightSavingAdjust(new Date($.getFullYear(), $.getMonth() - V[0] * V[1] + 1, $.getDate())), t = Q && Q > t ? Q : t; this._daylightSavingAdjust(new Date(et, Z, 1)) > t;) {
					Z--, 0 > Z && (Z = 11, et--);
				}
			}
